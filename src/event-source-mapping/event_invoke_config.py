        ...
        try:
            with self._get_connection() as conn:
                ...
                """, (
                    ...
                    config.get('DestinationConfig', {}).get('OnSuccess', {}).get('Destination'),
...
class EventInvokeConfig:
    ...
    def get_function_event_invoke_config(self, function_name: str,
                                         qualifier: str = '$LATEST') -> Optional[Dict]:
    ...
    def update_function_event_invoke_config(self, function_name: str,
                                           maximum_retry_attempts: Optional[int] = None,
                                           maximum_event_age_in_seconds: Optional[int] = None,
                                           destination_config: Optional[Dict] = None,
                                           qualifier: str = '$LATEST') -> Dict:
        ...
        update_config = {
            'Qualifier': qualifier,
            'MaximumRetryAttempts': maximum_retry_attempts if maximum_retry_attempts is not None else existing_config['MaximumRetryAttempts'],
            'MaximumEventAgeInSeconds': maximum_event_age_in_seconds if maximum_event_age_in_seconds is not None else existing_config['MaximumEventAgeInSeconds'],
        }
    ...
    def delete_function_event_invoke_config(self, function_name: str,
                                           qualifier: str = '$LATEST') -> bool:
        """Delete event invoke configuration"""
        return self.db.delete_config(function_name)

    def list_function_event_invoke_configs(self, function_name: Optional[str] = None) -> Dict:
